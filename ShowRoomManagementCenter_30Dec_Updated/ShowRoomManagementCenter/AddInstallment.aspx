<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddInstallment.aspx.cs" Inherits="ShowRoomManagementCenter.AddInstallment" %>
    ...
    <div style="width:80%;float:left;padding-left:10%;padding-right:10%; text-align:left">
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                                        <div style="width:80%;float:left;padding-left:17%; text-align:left;">
                                            <hr />
                                            <asp:Label ID="Label17" runat="server" Text="Select Cutomer CNIC:" ></asp:Label>
                                            ...
                                            <hr />
                                            <asp:Label ID="Label18" runat="server" Text="Select Engine Number:" ></asp:Label>
