<%@ Page Title="" Language="C#" MasterPageFile="~/ShowRoom.Master" AutoEventWireup="true" CodeBehind="MonthlySale.aspx.cs" Inherits="ShowRoomManagementCenter.MonthlySale" %>
    ...
    <div class="jumbotron">
        ...
        <div class="container">
            ...
            <br />
             ...
             <div class="row">
                           <div class="col-lg-2">
                                <asp:Label ID="Label2" runat="server" Font-Bold="true" Font-Size="Large" Text="Total Sale :"></asp:Label>
                          </div>
                          <div class="col-lg-3">
                                <asp:Label ID="lblTotalSales" runat="server" Font-Bold="true" Font-Size="Large" Text=""></asp:Label>
                          </div>

                   <div class="col-lg-2">
                                <asp:Label ID="Label3" runat="server" Font-Bold="true" Font-Size="Large" Text="Total Advance Amount :"></asp:Label>
                          </div>
                          <div class="col-lg-3">
                                <asp:Label ID="lblTotalAdvanceAmount" runat="server" Font-Bold="true" Font-Size="Large" Text=""></asp:Label>
                          </div>
            ...
            <div class="row">
                <!-- Blog Entries Column col-md-8  -->
                    <div class="col-lg-12">
                        <ig:WebDataGrid ID="webDataGrid_MonthySales" runat="server"  AutoGenerateColumns="False"  DefaultColumnWidth="170px" >
                            <Columns>
